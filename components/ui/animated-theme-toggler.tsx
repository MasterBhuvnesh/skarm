...
export const AnimatedThemeToggler = ({
  ...
  const toggleTheme = useCallback(() => {
    ...
    if (typeof (document as unknown as { startViewTransition?: unknown }).startViewTransition !== "function") {
      applyTheme()
      return
    }
    ...
    const transition = (document as unknown as { startViewTransition: (cb: () => void) => { finished: Promise<void>; ready: Promise<void> } }).startViewTransition(() => {
